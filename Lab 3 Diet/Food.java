 ...
 */public class Food {
	...
	private final TreeMap<String, NutritionalElement> rawMaterials = new TreeMap<>();
	private final TreeMap<String, NutritionalElement> products = new TreeMap<>();
	private final TreeMap<String, NutritionalElement> recipes = new TreeMap<>();
